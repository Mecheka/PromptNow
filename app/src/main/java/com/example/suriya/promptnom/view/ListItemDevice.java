...
public class ListItemDevice extends BaseCustomViewGroup {
    ...
    public ListItemDevice(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public ListItemDevice(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public ListItemDevice(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.list_item_device, this);
    }
