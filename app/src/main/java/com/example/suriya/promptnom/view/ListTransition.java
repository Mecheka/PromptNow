...
public class ListTransition extends BaseCustomViewGroup {
    ...
    public ListTransition(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public ListTransition(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public ListTransition(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.list_transition, this);
    }
